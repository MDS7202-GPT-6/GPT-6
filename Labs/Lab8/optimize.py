...
def optimize_model():
    ...
    exp_name = f"Lab8_XGBoost_Exp_{timestamp}"
    ...
    def objective(trial):
        ...
        run_name = f"XGB lr={params['learning_rate']:.3f} nest={params['n_estimators']} depth={params['max_depth']} mcw={params['min_child_weight']:.1f} subs={params['subsample']:.2f} col={params['colsample_bytree']:.2f} g={params['gamma']:.2f} a={params['reg_alpha']:.2f} l={params['reg_lambda']:.2f}"
