...
Una VM  implica instalar y configurar un sistema operativo completo, en cambio Docker se enfoca en empaquetar únicamente lo necesario para ejecutar la aplicación.
...
Ambos son archivos de configuración de Docker, pero con distintos propósitos:
- **Dockerfile:** define los pasos para construir imágenes (instalaciones, copias, puertos, comandos).  
- **docker-compose.yml:** crea varios contenedores y servicios (API, base de datos, etc.) de forma conjunta, es decir, levanta varios contenedores con una sola instrucción.